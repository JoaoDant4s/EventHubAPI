...
public class  EventhubApplication {
	...
	public CommandLineRunner init() {
		return args -> {
			...
			User user2 = new User("Promoter", "99.999.999/0001-01", "1982-10-11", "promoter", passwordEncoder.encode("123456789"), false, true);
			...
			User user7 = new User("Atração", "999.999.999-07", "1989-11-02", "attraction", passwordEncoder.encode("123456789"), false, false);
