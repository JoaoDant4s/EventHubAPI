...
public interface ITicketDaysService {
    ...
    List<TicketDays> saveTicketDays(List<TicketDays> ticketDays) throws NullParameterException, DataAlreadyExistsException;

    Optional<TicketDays> getTicketDaysById(LocalDate day, Ticket ticket) throws NullParameterException;
